            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                ...
                <div className="grid auto-rows-min gap-4 md:grid-cols-3">
                    <Link
                        ...
                        className="border-sidebar-border/70 dark:border-sidebar-border bg-card text-card-foreground hover:bg-accent flex flex-col items-start gap-3 overflow-hidden rounded-xl border p-6 shadow-sm transition"
                    >
